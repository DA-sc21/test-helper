...
const AdminCourseListSearchByProf = (props) => {
  ...
  useEffect(()=>{
    ...
    getDate();
    getCoursesListSearchByCourseProf();
  },[])
  ...
  //주소 바꾸기 !!!!!
  async function getCoursesListSearchByCourseProf(){
...
export default AdminCourseListSearchByProf;